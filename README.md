...
### 初期セットアップ
新しいプロジェクトフォルダを作成し、必要に応じてgit initしたあと、
.gitignore、gulpfile.js、package.json、package-lock.json、srcフォルダをコピーし
...
3.  **`dist` フォルダの中身をそのまま納品してください。**
    *   生成されるファイルは標準的な構成（ES Modulesなし）のため、ローカル環境でもダブルクリックで閲覧可能です。
